...
static GList *
rpcsyncwerk_objlisttest(int count, int len, const char *str)
{
    GList *ret=NULL;
    int i;
    for (i=0; i!=count; ++i)
...
main(int argc, char *argv[])
{
    ...
    while (1) {
        ...
        char *res = rpcsyncwerk_server_call_function ("rpcsyncwerk-demo", pac->data, fcall_len,
                                                 &ret_len);
        pac_ret = (packet *)buf;
