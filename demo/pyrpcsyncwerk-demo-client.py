...
from pyrpcsyncwerk import RpcsyncwerkClient, rpcsyncwerk_func
...
class SampleRpcClient(RpcsyncwerkClient):
    
    def call_remote_func_sync(self, fcall_str):
        """
        called by rpcsyncwerk_func to send the request and receive the result
        """
    ...
    def rpcsyncwerk_strlen(self):
        pass

client = SampleRpcClient()
res = client.rpcsyncwerk_strlen("hello world")
